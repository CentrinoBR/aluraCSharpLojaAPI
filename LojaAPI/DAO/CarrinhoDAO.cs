...
namespace LojaAPI.DAO
{
    public class CarrinhoDAO
    {
        ...
        static CarrinhoDAO()
        {
            Produto videogame = new Produto(6237, "Super Nintendo", 4000, 1);
            Produto esporte = new Produto(3467, "Super Star Soccer Delux", 60, 2);
            Carrinho carrinho = new Carrinho();
            carrinho.Adiciona(videogame);
            carrinho.Adiciona(esporte);
            carrinho.Endereco = "Setor SAGOCAN 2/4, Residencial Itamaraty, Taguatinga";
            carrinho.Id = 1;
